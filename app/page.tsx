...
export default function Home() {
  ...
  return <main className="shell">
    <aside className="sidebar"><div className="brand"><div className="brand-mark"><span>TT</span></div><div><strong>TTCGameLab</strong><small>LIVE CREATIVE STUDIO</small></div></div><Link href="/project/new" className="new-project"><span>＋</span> New Project</Link><nav><div className="nav-label">WORKSPACE</div><Link href="/" className="nav-item active"><span>⌂</span> Home</Link><Link href="/projects" className="nav-item"><span>▣</span> My Projects <b>3</b></Link><button className="nav-item"><span>✦</span> Asset Library</button></nav><div className="sidebar-bottom"><div className="status"><i /> AI Engine Ready</div><div className="profile"><div className="avatar">JT</div><div><strong>Creator</strong><small>Personal workspace</small></div><span>•••</span></div></div></aside>
    <section className="main"><header className="topbar"><div className="crumb"><span>Workspace</span><em>/</em><strong>Home</strong></div><div className="top-actions"><button className="icon-btn">⌕</button><button className="help">?</button><button className="profile-mini">JT</button></div></header><div className="content">
